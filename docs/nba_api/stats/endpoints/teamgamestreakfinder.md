...
_**WrsOPPSTL**_ |  |  | `Y` | 
_**WrsOPPREB**_ |  |  | `Y` | 
_**WrsOPPPTSPAINT**_ |  |  | `Y` | 
_**WrsOPPPTSOFFTOV**_ |  |  | `Y` | 
_**WrsOPPPTSFB**_ |  |  | `Y` | 
_**WrsOPPPTS2NDCHANCE**_ |  |  | `Y` | 
_**WrsOPPPTS**_ |  |  | `Y` | 
_**WrsOPPPF**_ |  |  | `Y` | 
_**WrsOPPOREB**_ |  |  | `Y` | 
_**WrsOPPFT_PCT**_ |  |  | `Y` | 
...
_**LtOPPREB**_ |  |  | `Y` | 
_**LtOPPPTSPAINT**_ |  |  | `Y` | 
_**LtOPPPTSOFFTOV**_ |  |  | `Y` | 
_**LtOPPPTSFB**_ |  |  | `Y` | 
_**LtOPPPTS2NDCHANCE**_ |  |  | `Y` | 
_**LtOPPPTS**_ |  |  | `Y` | 
_**LtOPPPF**_ |  |  | `Y` | 
_**LtOPPOREB**_ |  |  | `Y` | 
_**LtOPPFT_PCT**_ |  |  | `Y` | 
...
_**GtOPPREB**_ |  |  | `Y` | 
_**GtOPPPTSPAINT**_ |  |  | `Y` | 
_**GtOPPPTSOFFTOV**_ |  |  | `Y` | 
_**GtOPPPTSFB**_ |  |  | `Y` | 
_**GtOPPPTS2NDCHANCE**_ |  |  | `Y` | 
_**GtOPPPTS**_ |  |  | `Y` | 
_**GtOPPPF**_ |  |  | `Y` | 
_**GtOPPOREB**_ |  |  | `Y` | 
_**GtOPPFT_PCT**_ |  |  | `Y` | 
...
_**EqPTSOFFTOV**_ |  |  | `Y` | 
_**EqPTSFB**_ |  |  | `Y` | 
_**EqPTS2NDCHANCE**_ |  |  | `Y` | 
_**EqPTS**_ |  |  | `Y` | 
_**EqPF**_ |  |  | `Y` | 
_**EqOREB**_ |  |  | `Y` | 
_**EqOPPPTSPAINT**_ |  |  | `Y` | 
_**EqOPPPTSOFFTOV**_ |  |  | `Y` | 
_**EqOPPPTSFB**_ |  |  | `Y` | 
_**EqOPPPTS2NDCHANCE**_ |  |  | `Y` | 
_**EqMINUTES**_ |  |  | `Y` | 
_**EqFT_PCT**_ |  |  | `Y` | 
_**EqFTM**_ |  |  | `Y` | 
_**EqFTA**_ |  |  | `Y` | 
...
_**BtrOPPSTL**_ |  |  | `Y` | 
_**BtrOPPREB**_ |  |  | `Y` | 
_**BtrOPPPTSPAINT**_ |  |  | `Y` | 
_**BtrOPPPTSOFFTOV**_ |  |  | `Y` | 
_**BtrOPPPTSFB**_ |  |  | `Y` | 
_**BtrOPPPTS2NDCHANCE**_ |  |  | `Y` | 
_**BtrOPPPTS**_ |  |  | `Y` | 
_**BtrOPPPF**_ |  |  | `Y` | 
_**BtrOPPOREB**_ |  |  | `Y` | 
_**BtrOPPFT_PCT**_ |  |  | `Y` | 
