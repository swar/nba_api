# ScheduleLeagueV2Int
##### [nba_api/stats/endpoints/scheduleleaguev2int.py](https://github.com/swar/nba_api/blob/master/src/nba_api/stats/endpoints/scheduleleaguev2int.py)

##### Endpoint URL
>[https://stats.nba.com/stats/scheduleleaguev2int](https://stats.nba.com/stats/scheduleleaguev2int)

##### Valid URL
>[https://stats.nba.com/stats/scheduleleaguev2int?LeagueID=00&Season=2024-25](https://stats.nba.com/stats/scheduleleaguev2int?LeagueID=00&Season=2024-25)
...
#### BroadcasterList `broadcaster_list`
```text
['leagueId', 'seasonYear', 'broadcasterAbbreviation', 'broadcasterDisplay', 'broadcasterId', 'regionId']
```
