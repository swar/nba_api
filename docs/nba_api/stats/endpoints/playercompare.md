...
_**PlayerIDList**_ | [PlayerIDList](https://github.com/swar/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#PlayerIDList) | player_id_list |  | `Y` |  | 
...
_**VsPlayerIDList**_ | [VsPlayerIDList](https://github.com/swar/nba_api/blob/master/docs/nba_api/stats/library/parameters.md#VsPlayerIDList) | vs_player_id_list |  | `Y` |  | 
