...
class LeagueDashPlayerClutch(Endpoint):
    ...
    def load_response(self):
        ...
        self.league_dash_player_clutch = Endpoint.DataSet(data=data_sets['LeagueDashPlayerClutch'])
