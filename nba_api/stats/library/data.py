...
players = [
    ...
    [203518, "Abrines", "Alex", "Alex Abrines", True],
    ...
    [203112, "Acy", "Quincy", "Quincy Acy", True],
    ...
    [1629061, "Adel", "Deng", "Deng Adel", True],
    ...
    [1629152, "Akoon-Purcell", "DeVaughn", "DeVaughn Akoon-Purcell", True],
    ...
    [1628959, "Alkins", "Rawle", "Rawle Alkins", True],
    ...
    [1628443, "Allen", "Kadeem", "Kadeem Allen", True],
    ...
    [1626147, "Anderson", "Justin", "Justin Anderson", True],
    ...
    [201583, "Anderson", "Ryan", "Ryan Anderson", True],
    ...
    [1628387, "Anigbogu", "Ike", "Ike Anigbogu", True],
    ...
    [1627758, "Baker", "Ron", "Ron Baker", True],
    [452, "Baker", "Vin", "Vin Baker", False],
    [1627735, "Baldwin IV", "Wade", "Wade Baldwin IV", True],
    ...
    [200826, "Barea", "J.J.", "J.J. Barea", True],
    ...
    [201573, "Bayless", "Jerryd", "Jerryd Bayless", True],
    [76127, "Baylor", "Elgin", "Elgin Baylor", False],
    [203382, "Baynes", "Aron", "Aron Baynes", True],
    ...
    [201563, "Beasley", "Michael", "Michael Beasley", True],
    ...
    [201158, "Belinelli", "Marco", "Marco Belinelli", True],
    ...
    [1627733, "Bender", "Dragan", "Dragan Bender", True],
    ...
    [1629541, "Bertans", "Dairis", "Dairis Bertans", True],
    ...
    [1629167, "Bibbs", "Justin", "Justin Bibbs", True],
    ...
    [1628469, "Blakeney", "Antonio", "Antonio Blakeney", True],
    ...
    [201147, "Brewer", "Corey", "Corey Brewer", True],
    ...
    [1628515, "Briscoe", "Isaiah", "Isaiah Briscoe", True],
    ...
    [1629151, "Broekhoff", "Ryan", "Ryan Broekhoff", True],
    ...
    [202705, "Brooks", "MarShon", "MarShon Brooks", True],
    ...
    [203485, "Brown", "Lorenzo", "Lorenzo Brown", True],
    ...
    [203998, "Caboclo", "Bruno", "Bruno Caboclo", True],
    ...
    [101181, "Calderon", "Jose", "Jose Calderon", True],
    ...
    [203477, "Canaan", "Isaiah", "Isaiah Canaan", True],
    ...
    [201960, "Carroll", "DeMarre", "DeMarre Carroll", True],
    ...
    [1713, "Carter", "Vince", "Vince Carter", True],
    ...
    [201956, "Casspi", "Omri", "Omri Casspi", True],
    ...
    [1628505, "Caupain", "Troy", "Troy Caupain", True],
    [190, "Causwell", "Duane", "Duane Causwell", False],
    [1628463, "Cavanaugh", "Tyler", "Tyler Cavanaugh", True],
    ...
    [2199, "Chandler", "Tyson", "Tyson Chandler", True],
    [201163, "Chandler", "Wilson", "Wilson Chandler", True],
    ...
    [1629147, "Chealey", "Joe", "Joe Chealey", True],
    ...
    [1629109, "Clark", "Gary", "Gary Clark", True],
    [203546, "Clark", "Ian", "Ian Clark", True],
    ...
    [201954, "Collison", "Darren", "Darren Collison", True],
    [2555, "Collison", "Nick", "Nick Collison", False],
    [76422, "Colone", "Joe", "Joe Colone", False],
    [1629045, "Colson", "Bonzie", "Bonzie Colson", True],
    ...
    [202326, "Cousins", "DeMarcus", "DeMarcus Cousins", True],
    ...
    [203459, "Crabbe", "Allen", "Allen Crabbe", True],
    ...
    [201967, "Cunningham", "Dante", "Dante Cunningham", True],
    ...
    [203584, "Daniels", "Troy", "Troy Daniels", True],
    ...
    [1627738, "Davis", "Deyonta", "Deyonta Davis", True],
    [76521, "Davis", "Double D", "Double D Davis", False],
    [202334, "Davis", "Ed", "Ed Davis", True],
    ...
    [1629093, "Davis", "Tyler", "Tyler Davis", True],
    ...
    [1629116, "Delgado", "Angel", "Angel Delgado", True],
    ...
    [1629094, "Derrickson", "Marcus", "Marcus Derrickson", True],
    ...
    [1627767, "Diallo", "Cheick", "Cheick Diallo", True],
    ...
    [201162, "Dudley", "Jared", "Jared Dudley", True],
    ...
    [1628979, "Duval", "Trevon", "Trevon Duval", True],
    ...
    [1629053, "Edwards", "Vincent", "Vincent Edwards", True],
    ...
    [1627740, "Ellenson", "Henry", "Henry Ellenson", True],
    ...
    [203516, "Ennis III", "James", "James Ennis III", True],
    ...
    [1628980, "Evans", "Jacob", "Jacob Evans", True],
    [1628393, "Evans", "Jawun", "Jawun Evans", True],
    ...
    [201936, "Evans", "Tyreke", "Tyreke Evans", True],
    ...
    [202702, "Faried", "Kenneth", "Kenneth Faried", True],
    ...
    [1627812, "Ferrell", "Yogi", "Yogi Ferrell", True],
    ...
    [101112, "Frye", "Channing", "Channing Frye", True],
    ...
    [1628656, "Garrett", "Billy", "Billy Garrett", True],
    ...
    [201188, "Gasol", "Marc", "Marc Gasol", True],
    [2200, "Gasol", "Pau", "Pau Gasol", True],
    ...
    [1626780, "Gibson", "Jonathan", "Jonathan Gibson", True],
    ...
    [1629164, "Goodwin", "Brandon", "Brandon Goodwin", True],
    ...
    [101162, "Gortat", "Marcin", "Marcin Gortat", True],
    ...
    [1626203, "Graham", "Treveon", "Treveon Graham", True],
    ...
    [101123, "Green", "Gerald", "Gerald Green", True],
    ...
    [1627772, "Hamilton", "Daniel", "Daniel Hamilton", True],
    ...
    [1628605, "Hannahs", "Dusty", "Dusty Hannahs", True],
    ...
    [2734, "Harris", "Devin", "Devin Harris", True],
    ...
    [1626150, "Harrison", "Andrew", "Andrew Harrison", True],
    ...
    [203089, "Henson", "John", "John Henson", True],
    ...
    [1626209, "Hezonja", "Mario", "Mario Hezonja", True],
    [201579, "Hibbert", "Roy", "Roy Hibbert", False],
    [77016, "Hickey", "Matthew", "Matthew Hickey", False],
    [1628439, "Hicks", "Isaiah", "Isaiah Hicks", True],
    ...
    [77036, "Hoffman", "The Body", "The Body Hoffman", False],
    ...
    [204066, "Holland", "John", "John Holland", True],
    ...
    [1626178, "Hollis-Jefferson", "Rondae", "Rondae Hollis-Jefferson", True],
    ...
    [1629353, "Humphries", "Isaac", "Isaac Humphries", True],
    ...
    [1626154, "Hunter", "RJ", "RJ Hunter", True],
    ...
    [101141, "Ilyasova", "Ersan", "Ersan Ilyasova", True],
    ...
    [201281, "Ingram", "Andre", "Andre Ingram", True],
    ...
    [1627743, "Jackson", "Demetrius", "Demetrius Jackson", True],
    ...
    [1628518, "Jefferson", "Amile", "Amile Jefferson", True],
    ...
    [203098, "Jenkins", "John", "John Jenkins", True],
    ...
    [201973, "Jerebko", "Jonas", "Jonas Jerebko", True],
    ...
    [101161, "Johnson", "Amir", "Amir Johnson", True],
    ...
    [1629168, "Johnson", "BJ", "BJ Johnson", True],
    ...
    [204020, "Johnson", "Tyler", "Tyler Johnson", True],
    [77167, "Johnson", "Vinnie", "Vinnie Johnson", False],
    [202325, "Johnson", "Wesley", "Wesley Johnson", True],
    ...
    [1627883, "Jones", "Jalen", "Jalen Jones", True],
    [2592, "Jones", "James", "James Jones", False],
    [1629203, "Jones", "Jemerrio", "Jemerrio Jones", True],
    ...
    [203093, "Jones", "Terrence", "Terrence Jones", True],
    ...
    [203077, "Kidd-Gilchrist", "Michael", "Michael Kidd-Gilchrist", True],
    ...
    [202688, "Knight", "Brandon", "Brandon Knight", True],
    ...
    [1628995, "Knox", "Kevin", "Kevin Knox", True],
    ...
    [1629066, "Kurucs", "Rodions", "Rodions Kurucs", True],
    ...
    [201584, "Lee", "Courtney", "Courtney Lee", True],
    ...
    [1627215, "Lemon Jr.", "Walter", "Walter Lemon Jr.", True],
    ...
    [202720, "Leuer", "Jon", "Jon Leuer", True],
    ...
    [202391, "Lin", "Jeremy", "Jeremy Lin", True],
    ...
    [2733, "Livingston", "Shaun", "Shaun Livingston", True],
    ...
    [1629155, "Lofton", "Zach", "Zach Lofton", True],
    ...
    [1628399, "Lydon", "Tyler", "Tyler Lydon", True],
    ...
    [1629133, "Macon", "Daryl", "Daryl Macon", True],
    [1855, "Macon", "Mark", "Mark Macon", False],
    [1629122, "Macura", "J.P.", "J.P. Macura", True],
    ...
    [101133, "Mahinmi", "Ian", "Ian Mahinmi", True],
    ...
    [1626185, "Martin", "Jarell", "Jarell Martin", True],
    ...
    [201601, "Mbah a Moute", "Luc", "Luc Mbah a Moute", True],
    ...
    [1628769, "McCall", "Tahjere", "Tahjere McCall", True],
    ...
    [1627775, "McCaw", "Patrick", "Patrick McCaw", True],
    [77509, "McClain", "Dwayne", "Dwayne McClain", False],
    [77510, "McClain", "Hound Dog", "Hound Dog McClain", False],
    ...
    [1628035, "McKinnie", "Alfonzo", "Alfonzo McKinnie", True],
    ...
    [203895, "McRae", "Jordan", "Jordan McRae", True],
    ...
    [201975, "Meeks", "Jodie", "Jodie Meeks", True],
    ...
    [1626257, "Mejri", "Salah", "Salah Mejri", True],
    ...
    [203121, "Miller", "Darius", "Darius Miller", True],
    ...
    [1626259, "Miller", "Malcolm", "Malcolm Miller", True],
    ...
    [202703, "Mirotic", "Nikola", "Nikola Mirotic", True],
    ...
    [1628513, "Mitrou-Long", "Naz", "Naz Mitrou-Long", True],
    ...
    [202328, "Monroe", "Greg", "Greg Monroe", True],
    ...
    [1628500, "Moore", "Ben", "Ben Moore", True],
    ...
    [203961, "Moreland", "Eric", "Eric Moreland", True],
    ...
    [1628537, "Morris", "Jaylen", "Jaylen Morris", True],
    [202694, "Morris", "Marcus", "Marcus Morris", True],
    ...
    [202700, "Motiejunas", "Donatas", "Donatas Motiejunas", True],
    [1628405, "Motley", "Johnathan", "Johnathan Motley", True],
    ...
    [202389, "Mozgov", "Timofey", "Timofey Mozgov", True],
    [77657, "Mrazovich", "Chuck", "Chuck Mrazovich", False],
    [1626144, "Mudiay", "Emmanuel", "Emmanuel Mudiay", True],
    ...
    [1629058, "Musa", "Dzanan", "Dzanan Musa", True],
    ...
    [203894, "Napier", "Shabazz", "Shabazz Napier", True],
    ...
    [201149, "Noah", "Joakim", "Joakim Noah", True],
    ...
    [203124, "O'Quinn", "Kyle", "Kyle O'Quinn", True],
    ...
    [1629059, "Okobo", "Elie", "Elie Okobo", True],
    ...
    [2585, "Pachulia", "Zaza", "Zaza Pachulia", True],
    ...
    [2225, "Parker", "Tony", "Tony Parker", True],
    ...
    [202718, "Parsons", "Chandler", "Chandler Parsons", True],
    ...
    [1628383, "Patton", "Justin", "Justin Patton", True],
    ...
    [1629341, "Phillip", "Tarik", "Tarik Phillip", True],
    ...
    [203101, "Plumlee", "Miles", "Miles Plumlee", True],
    ...
    [202347, "Pondexter", "Quincy", "Quincy Pondexter", True],
    ...
    [1627816, "Poythress", "Alex", "Alex Poythress", True],
    ...
    [1628397, "Rabb", "Ivan", "Ivan Rabb", True],
    ...
    [200755, "Redick", "JJ", "JJ Redick", True],
    ...
    [1629244, "Reynolds", "Cameron", "Cameron Reynolds", True],
    ...
    [1627781, "Richardson", "Malachi", "Malachi Richardson", True],
    ...
    [203460, "Roberson", "Andre", "Andre Roberson", True],
    ...
    [1628421, "Robinson", "Devin", "Devin Robinson", True],
    ...
    [203922, "Robinson III", "Glenn", "Glenn Robinson III", True],
    ...
    [1629102, "Sampson", "Brandon", "Brandon Sampson", True],
    [203960, "Sampson", "JaKarr", "JaKarr Sampson", True],
    ...
    [203118, "Scott", "Mike", "Mike Scott", True],
    ...
    [200757, "Sefolosha", "Thabo", "Thabo Sefolosha", True],
    ...
    [202697, "Shumpert", "Iman", "Iman Shumpert", True],
    [203144, "Shved", "Alexey", "Alexey Shved", False],
    [1627783, "Siakam", "Pascal", "Pascal Siakam", True],
    [1626296, "Sibert", "Jordan", "Jordan Sibert", True],
    ...
    [203613, "Simmons", "Jonathon", "Jonathon Simmons", True],
    ...
    [2747, "Smith", "JR", "JR Smith", True],
    [2074, "Smith", "Jabari", "Jabari Smith", False],
    [201160, "Smith", "Jason", "Jason Smith", True],
    ...
    [1629034, "Spalding", "Ray", "Ray Spalding", True],
    ...
    [1629016, "Spellman", "Omari", "Omari Spellman", True],
    ...
    [203917, "Stauskas", "Nik", "Nik Stauskas", True],
    ...
    [203474, "Stephens", "DJ", "DJ Stephens", True],
    ...
    [202362, "Stephenson", "Lance", "Lance Stephenson", True],
    ...
    [1628403, "Swanigan", "Caleb", "Caleb Swanigan", True],
    ...
    [201952, "Teague", "Jeff", "Jeff Teague", True],
    ...
    [1628462, "Teodosic", "Milos", "Milos Teodosic", True],
    [78305, "Terrell", "Ira", "Ira Terrell", False],
    [1629123, "Terrell", "Jared", "Jared Terrell", True],
    ...
    [202498, "Thomas", "Lance", "Lance Thomas", True],
    ...
    [201229, "Tolliver", "Anthony", "Anthony Tolliver", True],
    ...
    [1629019, "Trier", "Allonzo", "Allonzo Trier", True],
    ...
    [200782, "Tucker", "PJ", "PJ Tucker", True],
    ...
    [202323, "Turner", "Evan", "Evan Turner", True],
    ...
    [2548, "Wade", "Dwyane", "Dwyane Wade", True],
    ...
    [203079, "Waiters", "Dion", "Dion Waiters", True],
    ...
    [1627820, "Wallace", "Tyrone", "Tyrone Wallace", True],
    ...
    [1627395, "Washburn", "Julian", "Julian Washburn", True],
    ...
    [1629118, "Welsh", "Thomas", "Thomas Welsh", True],
    ...
    [1627855, "White", "Okaro", "Okaro White", True],
    ...
    [1627785, "Whitehead", "Isaiah", "Isaiah Whitehead", True],
    ...
    [203912, "Wilcox", "CJ", "CJ Wilcox", False],
    ...
    [1626210, "Williams", "Alan", "Alan Williams", True],
    ...
    [203710, "Williams", "C.J.", "C.J. Williams", True],
    ...
    [1629140, "Williams", "Johnathan", "Johnathan Williams", True],
    ...
    [101107, "Williams", "Marvin", "Marvin Williams", True],
    ...
    [1627786, "Williams", "Troy", "Troy Williams", True],
    ...
    [201156, "Young", "Nick", "Nick Young", True],
    ...
    [203092, "Zeller", "Tyler", "Tyler Zeller", True],
    ...
    [1627790, "Zizic", "Ante", "Ante Zizic", True],
