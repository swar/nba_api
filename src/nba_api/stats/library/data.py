...
players = [
    ...
    [1641874, "Allegri", "Angelo", "Angelo Allegri", False],
    ...
    [1641710, "Black", "Anthony", "Anthony Black", False],
    ...
    [1641859, "Boum", "Souley", "Souley Boum", False],
    ...
    [1641738, "Brown", "Kobe", "Kobe Brown", False],
    ...
    [1641739, "Camara", "Toumani", "Toumani Camara", False],
    ...
    [1630658, "Castleton", "Colin", "Colin Castleton", False],
    ...
    [1631321, "Cissoko", "Sidy", "Sidy Cissoko", False],
    ...
    [1641730, "Clowney", "Noah", "Noah Clowney", False],
    ...
    [1641731, "Coulibaly", "Bilal", "Bilal Coulibaly", False],
    ...
    [1641915, "Daniels", "Caleb", "Caleb Daniels", False],
    ...
    [1641711, "Dick", "Gradey", "Gradey Dick", False],
    ...
    [1641787, "Evbuomwan", "Tosan", "Tosan Evbuomwan", False],
    ...
    [1641848, "Franklin", "Armaan", "Armaan Franklin", False],
    ...
    [1641917, "Funk", "Taylor", "Taylor Funk", False],
    ...
    [1641718, "George", "Keyonte", "Keyonte George", False],
    ...
    [1631221, "Gillespie", "Collin", "Collin Gillespie", False],
    ...
    [1631243, "Gueye", "Mouhamed", "Mouhamed Gueye", False],
    ...
    [1631289, "Hamilton", "Bryce", "Bryce Hamilton", False],
    ...
    [1641792, "Hauser", "Joey", "Joey Hauser", False],
    ...
    [1641722, "Hawkins", "Jordan", "Jordan Hawkins", False],
    ...
    [1641972, "Heidegger", "Max", "Max Heidegger", False],
    ...
    [1630703, "Henderson", "Scoot", "Scoot Henderson", False],
    [76996, "Henderson", "Tom", "Tom Henderson", False],
    [1641707, "Hendricks", "Taylor", "Taylor Hendricks", False],
    ...
    [1631096, "Holmgren", "Chet", "Chet Holmgren", False],
    ...
    [1641724, "Howard", "Jett", "Jett Howard", False],
    ...
    [1641713, "Jackson", "GG", "GG Jackson", False],
    ...
    [1641748, "Jackson Jr.", "Andre", "Andre Jackson Jr.", False],
    [1628991, "Jackson Jr.", "Jaren", "Jaren Jackson Jr.", True],
    [1631218, "Jackson-Davis", "Trayce", "Trayce Jackson-Davis", False],
    ...
    [1631170, "Jaquez Jr.", "Jaime", "Jaime Jaquez Jr.", False],
    ...
    [1641732, "Jones", "Colby", "Colby Jones", False],
    ...
    [1631340, "King", "Mojave", "Mojave King", False],
    ...
    [1630604, "Liddell", "E.J.", "E.J. Liddell", False],
    ...
    [1641726, "Lively II", "Dereck", "Dereck Lively II", False],
    [1630587, "Livers", "Isaiah", "Isaiah Livers", True],
    [1641753, "Livingston", "Chris", "Chris Livingston", False],
    ...
    [1630571, "Mayer", "Matthew", "Matthew Mayer", False],
    ...
    [1641756, "Miles Jr.", "Mike", "Mike Miles Jr.", False],
    ...
    [1641706, "Miller", "Brandon", "Brandon Miller", False],
    ...
    [1641757, "Miller", "Jordan", "Jordan Miller", False],
    [1631159, "Miller", "Leonard", "Leonard Miller", False],
    ...
    [1641760, "Moore", "Omari", "Omari Moore", False],
    ...
    [1631200, "Murray", "Kris", "Kris Murray", False],
    ...
    [1631250, "Nance", "Pete", "Pete Nance", False],
    ...
    [1641762, "Nnaji", "James", "James Nnaji", False],
    ...
    [1641893, "Obanor", "Kevin", "Kevin Obanor", False],
    [101177, "Oberto", "Fabricio", "Fabricio Oberto", False],
    [1629697, "Obiesie", "Joshua", "Joshua Obiesie", False],
    ...
    [1641861, "Ongenda", "Nick", "Nick Ongenda", False],
    ...
    [1641809, "Peterson", "Drew", "Drew Peterson", False],
    ...
    [1641763, "Phillips", "Julian", "Julian Phillips", False],
    [184, "Phills", "Bobby", "Bobby Phills", False],
    [15, "Piatkowski", "Eric", "Eric Piatkowski", False],
    [1629618, "Pickett", "Jalen", "Jalen Pickett", False],
    ...
    [1641764, "Podziemski", "Brandin", "Brandin Podziemski", False],
    ...
    [1641854, "Porter", "Craig", "Craig Porter", False],
    ...
    [1641920, "Powell", "Justin", "Justin Powell", False],
    ...
    [1641765, "Prosper", "Olivier-Maxence", "Olivier-Maxence Prosper", False],
    ...
    [1641811, "Rice", "Sir'Jabari", "Sir'Jabari Rice", False],
    ...
    [1641712, "Rupert", "Rayan", "Rayan Rupert", False],
    ...
    [1631204, "Sasser", "Marcus", "Marcus Sasser", False],
    ...
    [1641729, "Sensabaugh", "Brice", "Brice Sensabaugh", False],
    ...
    [1641767, "Sheppard", "Ben", "Ben Sheppard", False],
    ...
    [1641733, "Smith Jr.", "Nick", "Nick Smith Jr.", False],
    ...
    [1631124, "Strawther", "Julian", "Julian Strawther", False],
    ...
    [1641708, "Thompson", "Amen", "Amen Thompson", False],
    [1641709, "Thompson", "Ausar", "Ausar Thompson", False],
    ...
    [1631210, "Toppin", "Jacob", "Jacob Toppin", False],
    ...
    [1641816, "Tyson", "Hunter", "Hunter Tyson", False],
    ...
    [1641941, "Valerio-Bodon", "Vincent", "Vincent Valerio-Bodon", False],
    ...
    [1628426, "Vezenkov", "Aleksandar", "Aleksandar Vezenkov", False],
    ...
    [1641774, "Vukcevic", "Tristan", "Tristan Vukcevic", False],
    ...
    [1641716, "Walker", "Jarace", "Jarace Walker", False],
    [78439, "Walker", "Jimmy", "Jimmy Walker", False],
    [1641948, "Walker", "Jordan", "Jordan Walker", False],
    ...
    [1641717, "Wallace", "Cason", "Cason Wallace", False],
    ...
    [1641775, "Walsh", "Jordan", "Jordan Walsh", False],
    ...
    [1641705, "Wembanyama", "Victor", "Victor Wembanyama", False],
    ...
    [1641715, "Whitmore", "Cam", "Cam Whitmore", False],
    ...
    [1630592, "Wilson", "Jalen", "Jalen Wilson", False],
    ...
    [1628221, "York", "Gabe", "Gabe York", True],
