...
players = [
    ...
    [203500, "Adams", "Steven", "Steven Adams", False],
    ...
    [1642351, "Ajinca", "Melvin", "Melvin Ajinca", False],
    [76018, "Akin", "Henry", "Henry Akin", False],
    [1631231, "Akinjo", "James", "James Akinjo", False],
    ...
    [1641725, "Alexander", "Trey", "Trey Alexander", False],
    ...
    [1641851, "Allen", "Timmy", "Timmy Allen", True],
    ...
    [1628366, "Ball", "Lonzo", "Lonzo Ball", False],
    ...
    [1642419, "Battle", "Jamison", "Jamison Battle", False],
    ...
    [1641737, "Bona", "Adem", "Adem Bona", False],
    ...
    [1631167, "Brockington", "Izaiah", "Izaiah Brockington", True],
    ...
    [203493, "Bullock Jr.", "Reggie", "Reggie Bullock Jr.", True],
    ...
    [1641824, "Buzelis", "Matas", "Matas Buzelis", False],
    ...
    [1642382, "Carlson", "Branden", "Branden Carlson", False],
    ...
    [1642267, "Carrington", "Carlton", "Carlton Carrington", False],
    ...
    [1642269, "Carter", "Devin", "Devin Carter", False],
    ...
    [1630618, "Carton", "DJ", "DJ Carton", True],
    ...
    [1642264, "Castle", "Stephon", "Stephon Castle", False],
    ...
    [1630608, "Cazalon", "Malcolm", "Malcolm Cazalon", True],
    ...
    [1642353, "Christie", "Cam", "Cam Christie", False],
    ...
    [1641740, "Clark", "Jaylen", "Jaylen Clark", False],
    ...
    [1642270, "Clingan", "Donovan", "Donovan Clingan", False],
    ...
    [1642268, "Collier", "Isaiah", "Isaiah Collier", False],
    ...
    [1642384, "Crawford", "Isaiah", "Isaiah Crawford", False],
    ...
    [1642359, "Dadiet", "Pacome", "Pacome Dadiet", False],
    ...
    [1642368, "Dante", "N'Faly", "N'Faly Dante", False],
    ...
    [1641926, "Dennis", "Dexter", "Dexter Dennis", True],
    ...
    [1642265, "Dillingham", "Rob", "Rob Dillingham", False],
    ...
    [1642365, "Djurisic", "Nikola", "Nikola Djurisic", False],
    ...
    [1642452, "Domask", "Marcus", "Marcus Domask", False],
    ...
    [1630929, "Drell", "Henri", "Henri Drell", True],
    ...
    [1642346, "Dunn", "Ryan", "Ryan Dunn", False],
    ...
    [1641744, "Edey", "Zach", "Zach Edey", False],
    ...
    [1642348, "Edwards", "Justin", "Justin Edwards", False],
    ...
    [1642271, "Filipowski", "Kyle", "Kyle Filipowski", False],
    ...
    [1642280, "Flowers", "Trentyn", "Trentyn Flowers", False],
    ...
    [1630259, "Ford", "Jordan", "Jordan Ford", True],
    ...
    [1642402, "Freeman", "Enrique", "Enrique Freeman", False],
    [76755, "Freeman", "Gary", "Gary Freeman", False],
    [76756, "Freeman", "Rod", "Rod Freeman", False],
    [1631241, "Freeman-Liberty", "Javon", "Javon Freeman-Liberty", True],
    ...
    [1641788, "Fudge", "Alex", "Alex Fudge", True],
    ...
    [1642277, "Furphy", "Johnny", "Johnny Furphy", False],
    ...
    [1641945, "Galloway", "Jaylin", "Jaylin Galloway", True],
    ...
    [1629232, "Gates", "Kaiser", "Kaiser Gates", True],
    ...
    [1642273, "George", "Kyshawn", "Kyshawn George", False],
    ...
    [1630564, "Gray", "RaiQuan", "RaiQuan Gray", True],
    ...
    [1642396, "Hinson", "Blake", "Blake Hinson", False],
    ...
    [1641793, "Hodge", "D'Moi", "D'Moi Hodge", True],
    ...
    [1641842, "Holland II", "Ronald", "Ronald Holland II", False],
    ...
    [1630574, "Hukporti", "Ariel", "Ariel Hukporti", False],
    ...
    [1630562, "Hurt", "Matt", "Matt Hurt", True],
    ...
    [1642345, "Ighodaro", "Oso", "Oso Ighodaro", False],
    ...
    [1631127, "Ingram", "Harrison", "Harrison Ingram", False],
    ...
    [1641713, "Jackson II", "GG", "GG Jackson II", True],
    ...
    [1642355, "James", "Bronny", "Bronny James", False],
    ...
    [1642450, "Jenkins", "Daniss", "Daniss Jenkins", False],
    ...
    [1642358, "Johnson", "AJ", "AJ Johnson", False],
    ...
    [1642352, "Johnson", "Keshad", "Keshad Johnson", False],
    ...
    [1642357, "Jones", "David", "David Jones", False],
    ...
    [1642403, "Jones", "Isaac", "Isaac Jones", False],
    ...
    [1642461, "Jones", "Spencer", "Spencer Jones", False],
    ...
    [1641752, "Klintman", "Bobi", "Bobi Klintman", False],
    [77284, "Klotz", "Herm", "Herm Klotz", False],
    [77285, "Klueh", "Duane", "Duane Klueh", False],
    [1642261, "Knecht", "Dalton", "Dalton Knecht", False],
    ...
    [1642278, "Kolek", "Tyler", "Tyler Kolek", False],
    [1631132, "Koloko", "Christian", "Christian Koloko", False],
    ...
    [1641796, "Larsson", "Pelle", "Pelle Larsson", False],
    ...
    [1631213, "Martin", "Tyrese", "Tyrese Martin", False],
    ...
    [1631255, "Matkovic", "Karlo", "Karlo Matkovic", False],
    ...
    [1642272, "McCain", "Jared", "Jared McCain", False],
    ...
    [1630644, "McClung", "Mac", "Mac McClung", False],
    ...
    [1641755, "McCullar Jr.", "Kevin", "Kevin McCullar Jr.", False],
    ...
    [1641801, "Miller", "Emanuel", "Emanuel Miller", False],
    ...
    [1642434, "Minix", "Riley", "Riley Minix", False],
    ...
    [1642274, "Missi", "Yves", "Yves Missi", False],
    [1642349, "Mitchell", "Ajay", "Ajay Mitchell", False],
    ...
    [1642367, "Mogbo", "Jonathan", "Jonathan Mogbo", False],
    ...
    [1642361, "Nunez", "Juan", "Juan Nunez", False],
    ...
    [1641970, "Pereira", "Maozinha", "Maozinha Pereira", True],
    ...
    [1630196, "Petrusev", "Filip", "Filip Petrusev", True],
    ...
    [1631342, "Plowden", "Daeqwon", "Daeqwon Plowden", False],
    ...
    [1629645, "Porter Jr.", "Kevin", "Kevin Porter Jr.", False],
    ...
    [1642366, "Post", "Quinten", "Quinten Post", False],
    ...
    [1641810, "Reeves", "Antonio", "Antonio Reeves", False],
    ...
    [1642258, "Risacher", "Zaccharie", "Zaccharie Risacher", False],
    ...
    [1642275, "Salaun", "Tidjane", "Tidjane Salaun", False],
    ...
    [1641526, "Sane", "Babacar", "Babacar Sane", False],
    ...
    [1642259, "Sarr", "Alexandre", "Alexandre Sarr", False],
    ...
    [1631248, "Scheierman", "Baylor", "Baylor Scheierman", False],
    ...
    [1630286, "Scott", "Tre", "Tre Scott", False],
    ...
    [1630545, "Shannon Jr.", "Terrence", "Terrence Shannon Jr.", False],
    ...
    [1642347, "Shead", "Jamal", "Jamal Shead", False],
    ...
    [1642263, "Sheppard", "Reed", "Reed Sheppard", False],
    ...
    [1628424, "Simmons", "Kobi", "Kobi Simmons", True],
    ...
    [1642354, "Simpson", "K.J.", "K.J. Simpson", False],
    [78157, "Simpson", "Ralph", "Ralph Simpson", False],
    [1630285, "Simpson", "Zavier", "Zavier Simpson", True],
    ...
    [1631173, "Smith", "Terquavion", "Terquavion Smith", True],
    ...
    [1642285, "Spencer", "Cam", "Cam Spencer", False],
    ...
    [1641815, "Stevens", "Isaiah", "Isaiah Stevens", False],
    ...
    [1630569, "Steward", "DJ", "DJ Steward", False],
    ...
    [202738, "Thomas", "Isaiah", "Isaiah Thomas", True],
    ...
    [1642260, "Topic", "Nikola", "Nikola Topic", False],
    ...
    [1642281, "Tyson", "Jaylon", "Jaylon Tyson", False],
    ...
    [1628426, "Vezenkov", "Sasha", "Sasha Vezenkov", True],
    ...
    [1630811, "Wallace", "Keaton", "Keaton Wallace", False],
    ...
    [1642266, "Walter", "Ja'Kobe", "Ja'Kobe Walter", False],
    ...
    [1642276, "Ware", "Kel'el", "Kel'el Ware", False],
    ...
    [1642377, "Wells", "Jaylen", "Jaylen Wells", False],
    ...
    [1642262, "Williams", "Cody", "Cody Williams", False],
    ...
    [1642444, "Williams", "Jaylin", "Jaylin Williams", False],
    ...
    [1642013, "Williams", "Malik", "Malik Williams", True],
    ...
    [1642443, "Young", "Jahmir", "Jahmir Young", False],
    ...
    [1641783, "da Silva", "Tristan", "Tristan da Silva", False]
]
...
wnba_players = [
    ...
    [1641602, "Dojkic", "Ivana", "Ivana Dojkic", True],
