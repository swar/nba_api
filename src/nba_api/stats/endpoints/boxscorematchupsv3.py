...
class BoxScoreMatchupsV3(Endpoint):
    ...
    expected_data = {
        'PlayerStats': ['gameId', 'teamId', 'teamCity', 'teamName', 'teamTricode', 'teamSlug', 'personIdDef',
                        'firstNameDef', 'familyNameDef', 'nameIDef', 'playerSlugDef', 'positionDef', 'commentDef',
                        'jerseyNumDef', 'personIdOff', 'firstNameOff', 'familyNameOff', 'nameIOff', 'playerSlugOff',
                        'jerseyNumOff', 'matchupMinutes', 'matchupMinutesSort', 'partialPossessions',
                        ...
                        'helpFieldGoalsPercentage', 'matchupFreeThrowsMade', 'matchupFreeThrowsAttempted',
                        'shootingFouls']}
