...
deferred_endpoints = [
    ...
    DeferredEndpoint(ep.BoxScoreHustle, game_id='0021700807'),
    ...
    DeferredEndpoint(ep.GLAlumBoxScoreSimilarityScore, person1_id='2544', person2_id='2544'),
    ...
    DeferredEndpoint(ep.LeagueHustleStatsPlayerLeaders),
    DeferredEndpoint(ep.LeagueHustleStatsTeam),
    DeferredEndpoint(ep.LeagueHustleStatsTeamLeaders),
