...
def test_findbyfullname(fullname):
    ...
    print(f"Result of find_players_by_full_name('{fullname}'), n={len(result)}: {result}")
...
def test_findbyfirstname(firstname):
    ...
    print(f"Result of find_players_by_full_name('{firstname}'), n={len(result)}: {result}")
...
def test_findbylastname(lastname):
    ...
    print(f"Result of find_players_by_full_name('{lastname}'), n={len(result)}: {result}")
