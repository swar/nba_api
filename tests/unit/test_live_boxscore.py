...
def test_get_request_url():
    assert boxscore.BoxScore(game_id).get_request_url() == 'https://cdn.nba.com/static/json/liveData/boxscore/boxscore_0022000180.json'
...
def test_home_team_player_stats(nba_http_patch):
    assert boxscore.BoxScore(game_id).home_team_player_stats.get_dict() == content['game']['homeTeam']['players']
...
def test_away_team_player_stats(nba_http_patch):
    assert boxscore.BoxScore(game_id).away_team_player_stats.get_dict() == content['game']['awayTeam']['players']
